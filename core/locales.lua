...
GH.Locales = {
	pt = {
		...
		dropdown_bring_title = "Bring - Selecionar Player",
		...
		toast_bring_to = "Puxando %s!",
		toggle_bring = "Bring",
		desc_bring = "Puxa um jogador ate voce usando colisao fisica",
	...
	en = {
		...
		dropdown_bring_title = "Bring - Select Player",
		...
		toast_vehicle_to = "Vehicle -> %s",
		toast_target_fling = "Target Fling: %s",
		toast_bring_to = "Bringing %s!",
		toggle_bring = "Bring",
		desc_bring = "Pull a player to you using physics collision",
	...
	es = {
		...
		dropdown_bring_title = "Bring - Seleccionar Jugador",
		...
		toast_vehicle_to = "Vehicle -> %s",
		toast_target_fling = "Target Fling: %s",
		toast_bring_to = "Traendo %s!",
		toggle_bring = "Bring",
		desc_bring = "Trae un jugador hacia ti usando colision fisica",
