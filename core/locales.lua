...
GH.Locales = {
	pt = {
		...
		toggle_vehicletroll = "Vehicle Troll",
		-- Toggle descriptions
		...
		desc_vehicletroll = "Atropela infinitamente um jogador com veiculo, causando bug de colisao",
		desc_vehtp = "Lista players em veiculos e teleporta instantaneamente",
		input_vehtp_title = "Vehicle TP",
		tab_vehtp_saved = "Salvos",
		toast_vehtp_tp = "TP instantaneo para %s",
		toast_vehtp_not_in_vehicle = "Voce nao esta em um veiculo!",
		toast_vehtp_no_players = "Nenhum player em veiculo",
		toast_vehtp_player_left = "Player saiu do servidor!",
		tab_vehtp_players = "Players",
		input_vehtp_placeholder = "Procurar player...",
		dropdown_vehicletroll_title = "Vehicle Troll - Selecionar Alvo",
		toast_vehicletroll_start = "Atropelando %s!",
	...
	en = {
		...
		desc_vehicletroll = "Infinitely rams a player with your vehicle, causing physics collision bugs",
		desc_vehtp = "Lists players in vehicles with instant teleport",
		input_vehtp_title = "Vehicle TP",
		tab_vehtp_saved = "Saved",
		toast_vehtp_tp = "Instant TP to %s",
		toast_vehtp_not_in_vehicle = "You are not in a vehicle!",
		toast_vehtp_no_players = "No players in vehicles",
		toast_vehtp_player_left = "Player left the server!",
		tab_vehtp_players = "Players",
		input_vehtp_placeholder = "Search player...",
		dropdown_vehicletroll_title = "Vehicle Troll - Select Target",
		toast_vehicletroll_start = "Ramming %s!",
	...
	es = {
		...
		desc_vehicletroll = "Atropela infinitamente a un jugador con tu vehiculo, causando bugs de colision",
		desc_vehtp = "Lista players en vehiculos con teletransporte instantaneo",
		input_vehtp_title = "Vehicle TP",
		tab_vehtp_saved = "Guardados",
		toast_vehtp_tp = "TP instantaneo a %s",
		toast_vehtp_not_in_vehicle = "No estas en un vehiculo!",
		toast_vehtp_no_players = "No hay players en vehiculos",
		toast_vehtp_player_left = "Player salio del servidor!",
		tab_vehtp_players = "Players",
		input_vehtp_placeholder = "Buscar player...",
		dropdown_vehicletroll_title = "Vehicle Troll - Seleccionar Objetivo",
		toast_vehicletroll_start = "Atropellando a %s!",
