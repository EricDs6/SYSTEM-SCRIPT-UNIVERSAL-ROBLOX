...
GH.Locales = {
	pt = {
		...
		desc_vehtp = "Lista veiculos com coordenadas, teleporta instantaneamente e salva posicoes",
		input_vehtp_title = "Vehicle TP",
		input_vehtp_placeholder = "Procurar veiculo...",
		tab_vehtp_vehicles = "Veiculos",
	...
	en = {
		...
		desc_vehtp = "Lists vehicles with coordinates, instant teleport and save positions",
		input_vehtp_title = "Vehicle TP",
		input_vehtp_placeholder = "Search vehicle...",
		tab_vehtp_vehicles = "Vehicles",
	...
	es = {
		...
		desc_vehtp = "Lista vehiculos con coordenadas, teleporta instantaneamente y guarda posiciones",
		input_vehtp_title = "Vehicle TP",
		input_vehtp_placeholder = "Buscar vehiculo...",
		tab_vehtp_vehicles = "Vehiculos",
